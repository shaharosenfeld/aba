      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="md:w-1/2 order-1 md:order-2 space-y-6 text-right">
            ...
            עם ניסיון עשיר בניהול בכיר סמנכ"ל  וליווי חברות מובילות במשק ( תנובה , ויסוצקי,יוניליוור,סבון של פעם ,מחלבות רמת הגולן תופאפ ועוד ) , אני מתמחה בזיהוי חסמים עסקיים ופיתוח אסטרטגיות צמיחה מותאמות אישית עם דגש על תפעול ויצור, יעילות,לוגיסטיקה והפצה ,רכש ומלאי,איכות ,ניהול פרויקטים מורכבים . הגישה שלי משלבת ניתוח נתונים מעמיק עם הבנה פסיכולוגית של המערכת הארגונית.</p>
            <p className="text-slate-300 text-lg leading-relaxed">
